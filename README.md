...
- Возможность размещения алиаса образа в локальой регистраторе `d.ics.perm.ru` и в регистраторе Заказчика.
...
- Возможность расшиения образа в дальныйшем (добаление конфигурационных файлов, вспомогтельных скриптов, ...) 
